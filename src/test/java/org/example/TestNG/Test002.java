...
@BeforeTest
    ...
    public void testNonBDDPUTReq(){
        ...
        // Adding URI
        requestSpecification.baseUri("https://restful-booker.herokuapp.com/");
        requestSpecification.basePath("booking/4753");
        ...
        validatableResponse.body("firstname", Matchers.equalTo("Sneha"));

        // Validate value of lastName is updated
        validatableResponse.body("lastname", Matchers.equalTo("Sabu"));
